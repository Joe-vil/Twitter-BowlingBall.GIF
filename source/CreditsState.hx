...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Twitter BowlingBall.GIF'],
			['Joe-Vil',		'joevil',		'Programmer, Artist, Animator, and Covers',								'https://www.youtube.com/c/JoeTheHorse92/featured',	'740BD7'],
			['bb-panzu',	'bb-panzu',		'Composer of High Strike or better know as High Jinks',					'https://twitter.com/bbsub3',						'389A58'],
			['Biddle3',		'biddleicon',	'Composer of Balltasm or better know as Phantasm',						'https://twitter.com/Biddy312',						'45C84F'],
			['Psych Engine Team'],
